var round=Math.round,floor=Math.floor,abs=Math.abs,sqrt=Math.sqrt,PI=Math.PI, doc=document,win=window,hidden,BLINK_TO,BOX=false,CVS,SZ,CTR,CD,C,EASTER=false, cloudBuff,imgBuff,imgBuff2,nums,lp,tmp,stache,key;
